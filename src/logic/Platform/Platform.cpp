...
void Platform::deleteObserver() { this->observer = nullptr; }

void Platform::notifyObserver() { observer->update(); }

void Platform::notifyPosition(const Coordinates& coordinates) { observer->notifyPosition(coordinates); }

bool Platform::isGoingLeft() const { return goingLeft; }

void Platform::setGoingLeft(bool n_goingLeft) { Platform::goingLeft = n_goingLeft; }

bool Platform::isGoingUp() const { return goingUp; }

void Platform::setGoingUp(bool n_goingUp) { Platform::goingUp = n_goingUp; }

bool Platform::getHasBonus() const { return hasBonus; }

void Platform::setHasBonus(bool n_hasBonus) { Platform::hasBonus = n_hasBonus; }
} // namespace Logic_Library
